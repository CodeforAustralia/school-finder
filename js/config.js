...
(function () {
  ...
  app.geo = {
    ...
    tiles: 'https://api.tiles.mapbox.com/v4/techieshark.gjghn6pp/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoidGVjaGllc2hhcmsiLCJhIjoiYzk2ZEFWTSJ9.8ZY6rG2BWXkDBmvAPvn_nw',
    ...
    pickedIcons: {
      ...
      primary: L.MakiMarkers.icon({icon: "school", color: "#ff6666", size: "l"}),
    ...
    resultIcons: {
      ...
      // TODO: that green looks like the active primary color for color blind people.
      primary: L.MakiMarkers.icon({icon: "school", color: "#ff6666", size: "m"}),
    ...
    nearbyIcons: {
      ...
      // TODO: that green looks like the active primary color for color blind people.
      primary: L.MakiMarkers.icon({icon: "school", color: "#ff9933", size: "m", opacity: 0.5}),
      secondary: L.MakiMarkers.icon({icon: "school", color: "#cc66ff", size: "m", opacity: 0.5}),
