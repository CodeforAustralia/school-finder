...
$(function () {
  ...
  // app.geocoder = cachingGeocoder(app.googleGeocoder.initialize()).initialize();
  ...
  // var cachingRouteDistanceFn = _.partial(getCachedRouteDistance, distanceCache, app.googleDistanceService.initialize().getRouteDistance);
