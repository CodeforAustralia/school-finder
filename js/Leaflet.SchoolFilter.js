  ...
  L.Control.SchoolsNearby = L.Control.extend({
    ...
    onAdd: function () { // (map)
      ...
      container.innerHTML = ' ' +
        ...
        '     </div>' +
        '     <div class="feature">' +
        '      <input type="radio" id="nearby-intensive_english_centre" name="feature" value="intensive_english">' +
        '      <label for="nearby-intensive_english">Intensive English Centre</label>' +
        '     </div>' +
        '     <div class="feature">' +
...
//        }
  ...
  L.legend = function (btnMap) {
    var newControl = new L.Control.Legend();
    btnMap.addControl(newControl);
    return newControl;
  };
